...
* Build the mixed-format connectors with hadoop 2.x(the default is 3.x) dependencies: `./mvnw clean package -DskipTests -Phadoop2,spark-3.5 -pl '!amoro-ams,!dist'`. AMS, the optimizers and the distribution package require Hadoop 3.
