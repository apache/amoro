...
Amoro is built using Maven with JDK 8 (for ARM-based mac-os environments, use oracle's jdk ) and JDK 17(only for `amoro-format-mixed/amoro-mixed-trino` module).
