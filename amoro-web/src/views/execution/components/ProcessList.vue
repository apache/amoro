...
const columns = computed(() => [
  { dataIndex: 'tableName', title: t('table'), width: 300, scopedSlots: { customRender: 'tableName' } },
    { dataIndex: 'type', title: t('type'), width: 180, ellipsis: true },
    { dataIndex: 'status', title: t('status'), width: 180, ellipsis: true },
    ...
    { dataIndex: 'summary', title: t('summary'), width: 150, ellipsis: true },
])
...
<template>
  <div class="list-wrap">
    <a-space class="filter-form">
      ...
      <a-select
        v-model:value="actions" allow-clear placeholder="Types" :options="actionOptions" mode="multiple"
