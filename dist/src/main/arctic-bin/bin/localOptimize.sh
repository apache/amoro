...
$JAVA_RUN -Dlog.home=${LOG_DIR} -Dlog.subdir=localOptimizer-${6} -Xmx$1m com.netease.arctic.optimizer.local.LocalOptimizer -a $2 -q $3 -p $4 --heart-beat $5 -id $6 -es $7 -mm $8 >/dev/null