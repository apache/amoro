...
public class MaintainerOperationExecutor {
   ...
   *   <li>On success: record operation success with duration via {@link
   *       MaintainerMetrics#recordOperationSuccess}
   *   <li>On failure: record operation failure with duration via {@link
   *       MaintainerMetrics#recordOperationFailure} and rethrow the exception
   * </ol>
   *
