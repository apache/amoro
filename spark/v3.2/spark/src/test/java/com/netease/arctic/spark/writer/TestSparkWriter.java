...
public class TestSparkWriter extends SparkTableTestBase {
  ...
  public static Stream<Arguments> testWrite() {
    return Stream.of(
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, idPrimaryKeySpec,
            ptSpec, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, noPrimaryKey,
            ptSpec, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, idPrimaryKeySpec,
            unpartitioned, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, noPrimaryKey,
            unpartitioned, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, idPrimaryKeySpec,
            ptSpec, DEFAULT_FILE_FORMAT_ORC),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, noPrimaryKey,
            ptSpec, DEFAULT_FILE_FORMAT_ORC),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, idPrimaryKeySpec,
            unpartitioned, DEFAULT_FILE_FORMAT_ORC),
        Arguments.of(MIXED_HIVE, WriteMode.APPEND, schema, noPrimaryKey,
            unpartitioned, DEFAULT_FILE_FORMAT_ORC),

        Arguments.of(MIXED_HIVE, WriteMode.OVERWRITE_DYNAMIC, schema, idPrimaryKeySpec,
            ptSpec, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.OVERWRITE_DYNAMIC, schema, noPrimaryKey,
            ptSpec, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.OVERWRITE_DYNAMIC, schema, idPrimaryKeySpec,
            unpartitioned, DEFAULT_FILE_FORMAT_PARQUET),
        Arguments.of(MIXED_HIVE, WriteMode.OVERWRITE_DYNAMIC, schema, noPrimaryKey,
