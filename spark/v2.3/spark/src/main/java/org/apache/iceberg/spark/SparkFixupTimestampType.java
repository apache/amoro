...
/**
 * By default Spark type {@link Types.TimestampType} should be converted to
 * {@link Types.TimestampType#withZone()} iceberg type. But we also can convert
 * {@link Types.TimestampType} to {@link Types.TimestampType#withoutZone()} iceberg type
 * by setting {@link SparkSQLProperties#USE_TIMESTAMP_WITHOUT_TIME_ZONE_IN_NEW_TABLES} to 'true'
 */
// copied from iceberg project for adapt spark 2.3
