...
public class ArcticSqlCommandLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "KEY", "MIGRATE", "ARCTIC", "OPTIMIZE", "TABLE", "TO", 
			"REWRITE", "DATA", "USING", "BIN_PACK", "ADD", "AFTER", "ALL", "ALTER", 
			...
			"CURRENT_TIMESTAMP", "CURRENT_USER", "DAY", "DATABASE", "DATABASES", 
			...
			"STORED", "STRATIFY", "STRUCT", "SUBSTR", "SUBSTRING", "SYNC", "TABLES", 
			...
			"VALUES", "VIEW", "VIEWS", "WHEN", "WHERE", "WINDOW", "WITH", "YEAR", 
