...
import com.netease.arctic.spark.sql.catalyst.analysis.{ArcticPostAnalysisRule, ResolveArcticCommand}
...
class ArcticSparkExtensions extends (SparkSessionExtensions => Unit) {
  ...
  override def apply(extensions: SparkSessionExtensions): Unit = {
    ...
    extensions.injectPostHocResolutionRule(spark => ArcticPostAnalysisRule(spark))
