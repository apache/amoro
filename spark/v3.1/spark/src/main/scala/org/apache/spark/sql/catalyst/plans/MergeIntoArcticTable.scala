...
import org.apache.spark.sql.catalyst.plans.logical.{Command, DeleteAction, InsertAction, LogicalPlan, MergeAction, UpdateAction}
...
//  override def withNewRewritePlan(newRewritePlan: LogicalPlan): Command = {
//    copy(rewritePlan = Some(newRewritePlan))
//  }
//
//  override protected def withNewChildrenInternal(
//      newChildren: IndexedSeq[LogicalPlan]): MergeIntoArcticTable = {
//
//    newChildren match {
