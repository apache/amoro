...
Arctic Spark 目录下的文档均只针对 Mixed-Format 生效。如果您使用的是原生的 Iceberg 表，请参考 Iceberg 官方的用法
[Iceberg Spark使用指引](https://iceberg.apache.org/docs/latest/spark-ddl/)

## 环境准备

当前 Arctic-Spark-Connector 支持与 Spark3.1 版本使用。在开始使用前，
[下载](https://github.com/NetEase/arctic/releases/download/v0.3.2-rc1/arctic-spark_3.1-runtime-0.3.2.jar)并将 arctic-spark-3.1-runtime.jar 复制到
