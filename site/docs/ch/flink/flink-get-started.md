...
| ----------------- |---------------|  ----------------- |----------------------------------------------------------------------------------------------------------------------------|
| 0.4.0             | 1.12.x        | 0.12.0            | [flink-1.12-0.4.2-rc2](https://github.com/NetEase/arctic/releases/download/v0.4.0-rc2/arctic-flink-runtime-1.12-0.4.0.jar) |
| 0.4.0             | 1.14.x        | 0.12.0            | [flink-1.14-0.4.2-rc2](https://github.com/NetEase/arctic/releases/download/v0.4.0-rc2/arctic-flink-runtime-1.14-0.4.0.jar) |
| 0.4.0             | 1.15.x        | 0.12.0            | [flink-1.15-0.4.2-rc2](https://github.com/NetEase/arctic/releases/download/v0.4.0-rc2/arctic-flink-runtime-1.15-0.4.0.jar) |
