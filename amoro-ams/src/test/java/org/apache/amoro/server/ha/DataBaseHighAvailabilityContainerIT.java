...
/**
 * Derby-based integration tests for the JDBC HA container: leader election, failover on crash,
...
public class DataBaseHighAvailabilityContainerIT {
  ...
  private static boolean jdbcHAAvailable;

  @BeforeClass
  public static void checkJdbcHAExists() {
    jdbcHAAvailable = classExists("org.apache.amoro.server.ha.DataBaseHighAvailabilityContainer");
    Assume.assumeTrue(
        "Skip JDBC HA container tests because class not found (PR not merged)", jdbcHAAvailable);
