...
/** Verifies that the Paimon pending-input StateKey has correct configuration. */
public class TestPaimonTableRuntimePendingInput {
  ...
  public void paimonPendingInputKey_defaultValueIsPaimonPendingInput() {
    assertTrue(PAIMON_PENDING_INPUT_KEY.getDefaultValue() instanceof PaimonPendingInput);
  }

  @Test
  public void paimonPendingInputKey_deserializesPaimonType() {
    PaimonPendingInput result =
        PAIMON_PENDING_INPUT_KEY.deserialize("{\"dataFileCount\":42,\"healthScore\":85}");
