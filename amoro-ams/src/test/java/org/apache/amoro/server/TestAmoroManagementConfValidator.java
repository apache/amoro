...
public class TestAmoroManagementConfValidator {
  ...
  public void testValidateThreadCount() {
    ...
    configurations.setInteger(AmoroManagementConf.OPTIMIZING_QUEUE_WARMUP_THREAD_COUNT, -1);
    Assert.assertThrows(
        IllegalArgumentException.class,
        () -> AmoroManagementConfValidator.validateConfig(configurations));
    configurations.setInteger(AmoroManagementConf.OPTIMIZING_QUEUE_WARMUP_THREAD_COUNT, 10);
    AmoroManagementConfValidator.validateConfig(configurations);
