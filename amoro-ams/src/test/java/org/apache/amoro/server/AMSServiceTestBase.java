...
public abstract class AMSServiceTestBase extends AMSManagerTestBase {
  ...
  public static void initTableService() {
    ...
    TestActionCoordinator testActionCoordinator = new TestActionCoordinator();
    ...
    Mockito.when(actionCoordinatorManager.installedPlugins())
        .thenReturn(Lists.newArrayList(testActionCoordinator));

    TestExecuteEngine testExecuteEngine = new TestExecuteEngine();
    ...
    Mockito.when(executeEngineManager.installedPlugins())
        .thenReturn(Lists.newArrayList(testExecuteEngine));
    try {
