...
public class DefaultTableServiceOld extends PersistentBase implements TableServiceOld {

  public static final Logger LOG = LoggerFactory.getLogger(DefaultTableServiceOld.class);
  ...
  public DefaultTableServiceOld(Configurations configuration, CatalogManager catalogManager) {
