...
/** Table runtime implementation compatible with old version optimizing process. */
public class CompatibleTableRuntime extends DefaultTableRuntime implements TableRuntime {
