...
public class IcebergTableMaintainer implements TableMaintainer {
  ...
  public void expireDataFrom(DataExpirationConfig expirationConfig, Instant instant) {
    ...
    IcebergExpirationProcessor processor = new IcebergExpirationProcessor(table, expirationConfig);
    LOG.info(
        "Start to expire data in table {}(snapshot={}, level={}) before {}",
        table.name(),
        table.currentSnapshot().snapshotId(),
        expirationConfig.getExpirationLevel(),
        expireInstant);
