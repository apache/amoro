...
/**
 * Main entry point for Paimon Spark optimizer. Supports both optimizing and maintainer tasks.
 *
 * <p>Note: Optimizer functionality is currently not implemented. This class serves as a placeholder
...
public class SparkOptimizer extends Optimizer {
  ...
  private static final String APP_NAME_FORMAT = "amoro-paimon-spark-optimizer-%s";

  public SparkOptimizer(OptimizerConfig config, JavaSparkContext jsc) {
    super(config, () -> new OptimizerToucher(config), (i) -> new SparkOptimizerExecutor(config, i));
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    LOG.info("Starting the Paimon Spark optimizer with configuration:{}", config);
