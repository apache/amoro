...
public class PublicBaseMetastoreCatalog extends BaseMetastoreCatalog{

  private BaseMetastoreCatalog catalog;

  public PublicBaseMetastoreCatalog(BaseMetastoreCatalog catalog) {
  ...
  public String defaultWarehouseLocation(TableIdentifier tableIdentifier) {
    return catalog.defaultWarehouseLocation(tableIdentifier);
  }
