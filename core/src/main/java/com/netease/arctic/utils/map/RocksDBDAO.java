...
import com.netease.arctic.utils.ArcticException;
import com.netease.arctic.utils.ArcticTimer;
import com.netease.arctic.utils.FileIOUtils;
import com.netease.arctic.utils.Pair;
import com.netease.arctic.utils.SerializationUtils;
import com.netease.arctic.utils.ValidationUtils;
...
public class RocksDBDAO {
  ...
  public <T extends Serializable> Stream<Pair<String, T>> prefixSearch(String columnFamilyName, String prefix) {
    ValidationUtils.checkArgument(!closed);
    final ArcticTimer timer = new ArcticTimer();
    timer.startTimer();
  ...
  public synchronized void close() {
    if (!closed) {
      ...
      try {
        ...
        throw new ArcticException(e.getMessage(), e);
      }
    }
  }
