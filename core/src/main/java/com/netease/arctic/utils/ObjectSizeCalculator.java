...
/**
 * Contains utility methods for calculating the memory usage of objects. It only works on the HotSpot and OpenJ9 JVMs,
 * and infers the actual memory layout (32 bit vs. 64 bit word size, compressed object pointers vs. uncompressed)
 * from the best
...
public class ObjectSizeCalculator {
   ...
   *
   * @param obj the object; can be null. Passing in a {@link Class} object doesn't do anything special, it
  ...
  public static long getObjectSize(Object obj) throws UnsupportedOperationException {
    ...
    // especially when the `isAccessible` is false. More details in JEP 403. While integrating with other
    ...
    //       GraphLayout gives the deep size of an object, including the size of objects that are referenced
