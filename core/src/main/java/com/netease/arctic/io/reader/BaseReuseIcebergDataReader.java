...
import com.netease.arctic.scan.ReuseIcebergScanTask;
 ...
 */
public abstract class BaseReuseIcebergDataReader<T> {
  ...
  public BaseReuseIcebergDataReader(
  ...
  public CloseableIterable<T> readData(ReuseIcebergScanTask task) {
  ...
  public CloseableIterable<T> readDeletedData(ReuseIcebergScanTask task) {
