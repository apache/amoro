...
public class TableProperties {
  ...
  public static final String ENABLE_DATA_EXPIRATION = "table-expire.data.enabled";
  public static final boolean ENABLE_DATA_EXPIRATION_DEFAULT = false;
  public static final String DATA_EXPIRATION_LEVEL = "table-expire.data.level";
  public static final String DATA_EXPIRATION_LEVEL_DEFAULT = "partition";
  public static final String DATA_EXPIRATION_FIELD = "table-expire.data.field";
  public static final String DATA_EXPIRATION_DATE_STRING_FORMAT = "table-expire.data.datetime-string-format";
  public static final String DATA_EXPIRATION_DATE_STRING_FORMAT_DEFAULT = "yyyy-MM-dd";
