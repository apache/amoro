...
public class TableDataTestBase extends TableTestBase {
  ...
  public TableDataTestBase() {
    ...
    private static List<Record> baseRecords() {
      ...
      builder.add(DataTestHelpers.createRecord(1, "john", "2022-01-01T12:00:00"));
      builder.add(DataTestHelpers.createRecord(2, "lily", "2022-01-02T12:00:00"));
      builder.add(DataTestHelpers.createRecord(3, "jake", "2022-01-03T12:00:00"));
      builder.add(DataTestHelpers.createRecord(4, "sam", "2022-01-04T12:00:00"));
    ...
    private static List<Record> changeInsertRecords() {
      ImmutableList.Builder<Record> builder = ImmutableList.builder();
      builder.add(DataTestHelpers.createRecord(5, "mary", "2022-01-01T12:00:00"));
      builder.add(DataTestHelpers.createRecord(6, "mack", "2022-01-01T12:00:00"));
      return builder.build();
    }
