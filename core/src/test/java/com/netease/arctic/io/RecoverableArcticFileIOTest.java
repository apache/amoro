...
public class RecoverableArcticFileIOTest extends TableTestBase {
  ...
  @Override
  public void before() {
    this.table = testKeyedTable;
    ArcticTable arcticTable = this.table;
    ...
    file1 = testKeyedTable.location() + "/base/test/test1/test1.parquet";
    file2 = testKeyedTable.location() + "/base/test/test2/test2.parquet";
    file3 = testKeyedTable.location() + "/base/test/test2.parquet";
  }
