...
public class ArcticSourceEnumerator extends AbstractArcticEnumerator {
   ...
   * ArcticSourceReader} after ArcticReaders have finished reading all {@link TemporalJoinSplits}.
   * Then {@link ArcticSourceReader} will emit a Watermark values Long.MAX_VALUE. Advancing
   ...
   * send a {@link InitializationFinishedEvent} to notify all {@link ArcticSourceReader}.
   *
