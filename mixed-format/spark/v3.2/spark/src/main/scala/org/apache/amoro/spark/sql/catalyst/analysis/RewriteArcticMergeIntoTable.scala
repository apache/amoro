...
import org.apache.amoro.spark.sql.catalyst.plans.{ArcticRowLevelWrite, MergeIntoArcticTable, MergeRows}
...
import org.apache.spark.sql.amoro.catalyst.{ArcticSpark32Helper, ExpressionHelper}
          ...
          val (keyAttrs, valuesRelation) = {
            if (arctic.requireAdditionIdentifierColumns()) {
              ...
              throw new UnsupportedOperationException(
                s"Can not build relation and keyAttrs for table $arctic")
            }
          }
