 ...
 */
public class LogKafkaSourceReader<T> extends SingleThreadMultiplexSourceReaderBase<
    LogRecordWithRetractInfo<RowData>, T, KafkaPartitionSplit, KafkaPartitionSplitState> {
  ...
  public LogKafkaSourceReader(
      ...
      RecordEmitter<LogRecordWithRetractInfo<RowData>, T, KafkaPartitionSplitState> recordEmitter,
      Configuration config,
      SourceReaderContext context,
      @Nullable LogSourceHelper logReadHelper) {
    super(
        elementsQueue,
        new LogKafkaSourceFetcherManager<>(elementsQueue, splitReaderSupplier::get),
        recordEmitter,
        config,
        context);
  ...
  public void notifyCheckpointComplete(long checkpointId) throws Exception {
    ...
    ((LogKafkaSourceFetcherManager) splitFetcherManager)
        .commitOffsets(
