...
public class UnkeyedInputFormatSourceFunction extends RichParallelSourceFunction<RowData> {
  ...
  private org.apache.iceberg.flink.source.FlinkInputFormat format;
  private ProxyFactory<org.apache.iceberg.flink.source.FlinkInputFormat> formatFactory;
  ...
  public UnkeyedInputFormatSourceFunction(
      ProxyFactory<org.apache.iceberg.flink.source.FlinkInputFormat> formatFactory,
   ...
   */
  public org.apache.iceberg.flink.source.FlinkInputFormat getFormat() {
    return format;
  }
