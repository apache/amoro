...
public class TestArcticCatalogTablePartitions extends FlinkTestBase {
  ...
  public void testListPartitionsUnKeyedTable() throws TableNotPartitionedException {
    ...
    sql("CREATE TABLE IF NOT EXISTS arcticCatalog." + db + "." + tableName + "(" +
    ...
    CatalogPartitionSpec partitionSpec1 = new CatalogPartitionSpec(ImmutableMap.of("dt", "2023-10-01"));
    CatalogPartitionSpec partitionSpec2 = new CatalogPartitionSpec(ImmutableMap.of("dt", "2023-10-02"));
  ...
  public void testListPartitionsKeyedTable() throws TableNotPartitionedException {
    ...
    DataStreamSource<RowData> rowData = getEnv().fromCollection(DataUtil.toRowData(data),
    ...
    expected.add(partitionSpec1);
    expected.add(partitionSpec2);
    Assert.assertEquals("Should produce the expected catalog partition specs.", partitionList, expected);
  }
}
