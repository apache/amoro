...
public class KafkaContainerTest {
  ...
  public static ConsumerRecords<String, String> readRecords(String topic) {
    Properties properties = KafkaConfigGenerate.getProperties();
  ...
  public static ConsumerRecords<byte[], byte[]> readRecordsBytes(String topic) {
    return (ConsumerRecords<byte[], byte[]>) readRecords(topic, KafkaConfigGenerate.getPropertiesWithByteArray());
  }
  ...
  public static Properties getPropertiesByTopic(String topic) {
    Properties properties = KafkaConfigGenerate.getPropertiesWithByteArray(KafkaConfigGenerate.getProperties());
  ...
  public static KafkaProducer getProducer() {
    Properties properties = KafkaConfigGenerate.getPropertiesWithByteArray();
