...
class ArcticEnumeratorOffsetSerializer
  ...
  @Override
  public byte[] serialize(ArcticEnumeratorOffset position) throws IOException {
    return serializeV1(position);
  }

  @Override
  public ArcticEnumeratorOffset deserialize(int version, byte[] serialized) throws IOException {
    switch (version) {
      case 1:
  ...
  private byte[] serializeV1(ArcticEnumeratorOffset position) throws IOException {
  ...
  private ArcticEnumeratorOffset deserializeV1(byte[] serialized) throws IOException {
