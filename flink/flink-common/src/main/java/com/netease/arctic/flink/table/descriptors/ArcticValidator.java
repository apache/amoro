...
public class ArcticValidator extends ConnectorDescriptorValidator {
  ...
  @Deprecated public static final String ARCTIC_THROUGHPUT_METRIC_ENABLE_LEGACY = "metrics.enable";
  ...
  public static final ConfigOption<Boolean> ARCTIC_LOG_KAFKA_COMPATIBLE_ENABLE =
      ConfigOptions.key("log-store.kafka.compatible.enabled")
          ...
          .defaultValue(false)
          .withDescription(
              "Flag hidden kafka reading compatible with legacy Kafka Source API enable or not"
  ...
  public static final ConfigOption<String> SCAN_STARTUP_MODE =
      ConfigOptions.key("scan.startup.mode")
          ...
          .withDescription(
              String.format(
                  "Optional startup mode for arctic source, valid values are "
  ...
  public static final ConfigOption<Boolean> SUBMIT_EMPTY_SNAPSHOTS =
      ConfigOptions.key("submit.empty.snapshots")
          ...
          .defaultValue(false)
          .withDescription(
              "Optional submit empty snapshots to the arctic table, false means that writers will not emit"
  ...
  public static final ConfigOption<Boolean> DIM_TABLE_ENABLE =
      ConfigOptions.key("dim-table.enabled")
          ...
          .defaultValue(false)
          .withDescription(
              "If it is true, Arctic source will generate watermark after stock data being read");
  ...
  public static final ConfigOption<Duration> AUTO_EMIT_LOGSTORE_WATERMARK_GAP =
      ConfigOptions.key("arctic.emit.auto-write-to-logstore.watermark-gap")
          ...
          .noDefaultValue()
          .withDescription(
              "Only enabled when 'arctic.emit.mode'='auto', if the watermark of the arctic writers"
  ...
  public static final ConfigOption<Boolean> LOG_STORE_CATCH_UP =
      ConfigOptions.key("log-store.catch-up")
          ...
          .defaultValue(false)
          .withDescription(
              "If it is true, Arctic source will emit data to filestore and logstore. If it is false,"
  ...
  public static final ConfigOption<Long> LOG_STORE_CATCH_UP_TIMESTAMP =
      ConfigOptions.key("log-store.catch-up-timestamp")
          ...
          .defaultValue(0L)
          .withDescription(
              "Mark the time to start double writing (the logstore of arctic table catches up with the"
                  + " historical data).");
  ...
  public void validate(DescriptorProperties properties) {
    ...
    if (StringUtils.isBlank(emitMode)) {
      throw new ValidationException("None value for property '" + ARCTIC_EMIT_MODE.key());
    }
