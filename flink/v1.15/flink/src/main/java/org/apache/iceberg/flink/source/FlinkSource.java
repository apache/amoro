...
public class FlinkSource {
  ...
  public static class Builder {
    ...
    public DataStream<RowData> build() {
      ...
      ArcticScanContext context = contextBuilder.build();
    ...
    int inferParallelism(FlinkInputFormat format, ArcticScanContext context) {
  ...
  public static boolean isBounded(Map<String, String> properties) {
    return !ArcticScanContext.builder().fromProperties(properties).build().isStreaming();
  }
}
