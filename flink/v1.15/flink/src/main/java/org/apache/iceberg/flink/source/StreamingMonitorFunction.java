 ...
 *
 * <p>This is the single (non-parallel) monitoring task which takes a {@link FlinkInputFormat},
...
public class StreamingMonitorFunction extends RichSourceFunction<FlinkInputSplit> implements CheckpointedFunction {
  ...
  public StreamingMonitorFunction(TableLoader tableLoader, ArcticScanContext scanContext) {
