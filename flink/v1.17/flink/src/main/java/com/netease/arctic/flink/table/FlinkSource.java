...
public class FlinkSource {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ArcticScanContext.class);
  ...
  public static final class Builder {
    ...
    public DataStream<RowData> build() {
      ...
      if (arcticTable.isUnkeyedTable()) {
        boolean unKeyedTableIsStreaming =
            env.getConfiguration().get(ExecutionOptions.RUNTIME_MODE).equals(RuntimeExecutionMode.STREAMING);
        return buildUnkeyedTableSource(unKeyedTableIsStreaming);
      }
    ...
    public DataStream<RowData> buildUnkeyedTableSource(boolean unKeyedTableIsStreaming) {
      LOG.info("xxx buildUnkeyedTableSource {}", unKeyedTableIsStreaming);
      DataStream<RowData> origin = org.apache.iceberg.flink.source.FlinkSource.forRowData()
          .env(env)
          .streaming(unKeyedTableIsStreaming)
