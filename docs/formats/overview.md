...
- New formats such as Iceberg/Delta/Paimon further define the relationship between tables and snapshots, and the relationship between snapshots and files.
...
[Delta](https://delta.io/) and [Paimon](https://paimon.apache.org/) may have some differences in specific functions, but we see that the standard of table formats is gradually established with the functional convergence of these open-source projects in the past years.
...
Currently, Amoro mainly provides the following table formats:
