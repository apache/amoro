...
| self-optimizing.rewrite.use-parquet-row-group-merge.enabled | false | Whether to enable parquet row-group merge for eligible rewrite of Parquet files without delete files, bloom filters, sort order, or spec mismatches; otherwise falls back to row-based rewrite.                                                                                             |
