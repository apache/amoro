...
import org.apache.amoro.spark.sql.ArcticExtensionUtils.{asTableRelation, isArcticRelation, ArcticTableHelper}
import org.apache.amoro.spark.sql.catalyst.plans.ArcticRowLevelWrite
import org.apache.amoro.spark.sql.utils.{ArcticRewriteHelper, ProjectingInternalRow, WriteQueryProjections}
...
import org.apache.amoro.spark.table.{ArcticSparkTable, SupportsExtendIdentColumns, SupportsRowLevelOperator}
import org.apache.amoro.spark.writer.WriteMode
import org.apache.spark.sql.SparkSession
import org.apache.spark.sql.amoro.catalyst.ArcticSpark32Helper
...
case class RewriteUpdateArcticTable(spark: SparkSession) extends Rule[LogicalPlan]
  ...
  override def apply(plan: LogicalPlan): LogicalPlan = plan match {
    case u: UpdateTable if isArcticRelation(u.table) =>
      ...
      val writeBuilder =
        ArcticSpark32Helper.newWriteBuilder(arcticRelation.table, query.schema, options)
