...
public class MixedFormatSqlExtendParser extends Parser {
	...
	public static class ColPositionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MixedFormatSqlExtendListener ) ((MixedFormatSqlExtendListener)listener).enterColPosition(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MixedFormatSqlExtendListener ) ((MixedFormatSqlExtendListener)listener).exitColPosition(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MixedFormatSqlExtendVisitor ) return ((MixedFormatSqlExtendVisitor<? extends T>)visitor).visitColPosition(this);
			else return visitor.visitChildren(this);
		}
	}
