...
public class KeyedConnectorPageSource implements ConnectorPageSource {
  ...
  private final AdaptHiveMixedDeleteFilter<TrinoRow> amoroDeleteFilter;
  ...
  public KeyedConnectorPageSource(
      ...
      AdaptHiveMixedDeleteFilter<TrinoRow> amoroDeleteFilter) {
    ...
    this.amoroDeleteFilter = amoroDeleteFilter;
  ...
  private ConnectorPageSource open(MixedFileScanTask mixedFileScanTask) {
    ...
    amoroDeleteFilter.setCurrentDataPath(mixedFileScanTask.file().path().toString());
