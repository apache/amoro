...
public class FlinkDynamicTableFactory
  ...
  protected final FlinkCatalog catalog;
  ...
  public DynamicTableSource createDynamicTableSource(Context context) {
    ...
    return new IcebergTableSource(
        tableLoader, tableSchema, tableProps, context.getConfiguration(), null);
  }
  ...
  protected static TableLoader createTableLoader(
  ...
  protected static TableLoader createTableLoader(FlinkCatalog catalog, ObjectPath objectPath) {
