...
public class TestAmoroFileWriter extends FlinkTestBase {
  ...
  public static OneInputStreamOperatorTestHarness<RowData, WriteResult> createArcticStreamWriter(
      AmoroTableLoader tableLoader) throws Exception {
    return createArcticStreamWriter(tableLoader, true, null);
  }

  public static OneInputStreamOperatorTestHarness<RowData, WriteResult> createArcticStreamWriter(
      AmoroTableLoader tableLoader, boolean submitEmptySnapshots, Long restoredCheckpointId)
      throws Exception {
  ...
  public void testInsertWrite() throws Exception {
    ...
    try (OneInputStreamOperatorTestHarness<RowData, WriteResult> testHarness =
      ...
      AmoroFileWriter fileWriter = (AmoroFileWriter) testHarness.getOneInputOperator();
  ...
  public void testEmitEmptyResults() throws Exception {
    ...
    try (OneInputStreamOperatorTestHarness<RowData, WriteResult> testHarness =
        createArcticStreamWriter(tableLoader, submitEmptySnapshots, null)) {
      // The first checkpoint
