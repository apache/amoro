...
import org.apache.amoro.flink.read.TestMixedFormatSource;
...
public class MixedFormatFileWriterITCase extends FlinkTestBase {

  public static final Logger LOG = LoggerFactory.getLogger(MixedFormatFileWriterITCase.class);
  ...
  public MixedFormatFileWriterITCase() {
    super(
  ...
  public void testWrite() throws Exception {
    ...
    KeyedTable keyedTable = tableLoader.loadMixedFormatTable().asKeyedTable();
