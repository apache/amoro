...
import org.apache.amoro.flink.read.TestAmoroSource;
...
public class AmoroFileWriterITCase extends FlinkTestBase {

  public static final Logger LOG = LoggerFactory.getLogger(AmoroFileWriterITCase.class);
  ...
  public static void checkResult(KeyedTable keyedTable, int exceptedSize) {
    ...
    Assert.assertEquals(exceptedSize, TestAmoroSource.tableRecords(keyedTable).size());
  }
}
