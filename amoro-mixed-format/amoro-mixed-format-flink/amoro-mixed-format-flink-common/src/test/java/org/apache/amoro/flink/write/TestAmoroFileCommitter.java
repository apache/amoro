...
public class TestAmoroFileCommitter extends FlinkTestBase {
  public AmoroTableLoader tableLoader;

  public TestAmoroFileCommitter() {
    super(
  ...
  public OneInputStreamOperatorTestHarness<WriteResult, Void> createArcticFileCommitter(
      AmoroTableLoader tableLoader, MixedTable table, OperatorSubtaskState operatorSubtaskState)
      throws Exception {
  ...
  public void testCommit() throws Exception {
    ...
    KeyedTable table = AmoroUtils.loadArcticTable(tableLoader).asKeyedTable();
  ...
  private List<WriteResult> prepareChangeFiles() throws Exception {
    ...
    try (OneInputStreamOperatorTestHarness<RowData, WriteResult> testHarness =
        TestAmoroFileWriter.createArcticStreamWriter(tableLoader)) {
