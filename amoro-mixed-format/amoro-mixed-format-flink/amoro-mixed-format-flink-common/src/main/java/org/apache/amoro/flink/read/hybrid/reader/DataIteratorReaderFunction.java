...
public abstract class DataIteratorReaderFunction<T> implements ReaderFunction<T> {
  ...
  public abstract DataIterator<T> createDataIterator(AmoroSplit split);

  @Override
  public CloseableIterator<RecordsWithSplitIds<AmoroRecordWithOffset<T>>> apply(AmoroSplit split) {
