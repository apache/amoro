...
/**
 * Enumerator for arctic source, assign {@link AmoroSplit} to arctic source reader {@link
 * HybridSplitReader}
 */
public class AmoroSourceEnumerator extends AbstractAmoroEnumerator {
  private static final Logger LOG = LoggerFactory.getLogger(AmoroSourceEnumerator.class);
  ...
  private final SplitEnumeratorContext<AmoroSplit> context;
  ...
  /**
   * If true, using arctic table as build table. {@link AmoroSourceEnumerator} will notify {@link
   * AmoroSourceReader} after ArcticReaders have finished reading all {@link TemporalJoinSplits}.
   * Then {@link AmoroSourceReader} will emit a Watermark values Long.MAX_VALUE. Advancing
  ...
  public void start() {
    ...
    if (enumeratorPosition.get() == null
      ...
      enumeratorPosition.set(AmoroEnumeratorOffset.of(snapshotId, null));
      LOG.info(
   ...
   * send a {@link InitializationFinishedEvent} to notify all {@link AmoroSourceReader}.
   *
