...
public class AmoroDynamicSink implements DynamicTableSink, SupportsPartitioning, SupportsOverwrite {

  public static final Logger LOG = LoggerFactory.getLogger(AmoroDynamicSink.class);
  ...
  AmoroDynamicSink(
      CatalogTable flinkTable, AmoroTableLoader tableLoader, boolean primaryKeyExisted) {
