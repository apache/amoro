...
import org.apache.amoro.flink.lookup.AmoroRowDataLookupFunction;
...
public class AmoroDynamicSource
  ...
  private static final Logger LOG = LoggerFactory.getLogger(AmoroDynamicSource.class);
  ...
  protected final AmoroTableLoader tableLoader;
  ...
  protected LookupFunction getLookupFunction(int[] joinKeys) {
    ...
    return new AmoroRowDataLookupFunction(
  ...
  protected AbstractAdaptHiveKeyedDataReader<RowData> generateMORReader(
    ...
    return new FlinkAmoroMORDataReader(
        mixedTable.io(),
        mixedTable.schema(),
        projectedSchema,
        mixedTable.asKeyedTable().primaryKeySpec(),
