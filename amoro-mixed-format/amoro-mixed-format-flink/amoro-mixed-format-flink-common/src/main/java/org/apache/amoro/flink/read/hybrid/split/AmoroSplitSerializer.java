...
/** Serializer that serializes and deserializes {@link AmoroSplit}. */
public class AmoroSplitSerializer implements SimpleVersionedSerializer<AmoroSplit> {
  public static final AmoroSplitSerializer INSTANCE = new AmoroSplitSerializer();
  ...
  @Override
  public byte[] serialize(AmoroSplit split) throws IOException {
    if (split == null) {
      return new byte[0];
    }
  ...
  @Override
  public AmoroSplit deserialize(int version, byte[] serialized) throws IOException {
