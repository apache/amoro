...
/**
 * This is the general entry of an amoro writer that wraps different operators insides.
 *
 * @param <OUT>
 */
public class AmoroWriter<OUT> extends AbstractStreamOperator<OUT>
  ...
  private final AmoroLogWriter logWriter;
