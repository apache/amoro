...
/**
 * Arctic source reader that is created by a {@link AmoroSource#createReader(SourceReaderContext)}.
 */
public class AmoroSourceReader<T>
    extends SingleThreadMultiplexSourceReaderBase<
        AmoroRecordWithOffset<T>, T, AmoroSplit, AmoroSplitState> {

  public static final Logger LOGGER = LoggerFactory.getLogger(AmoroSourceReader.class);
  ...
  public AmoroSourceReader(
    ...
    super(
        ...
        new AmoroRecordEmitter<T>(populateRowTime),
        config,
        context);
  }
  ...
  @Override
  protected void onSplitFinished(Map<String, AmoroSplitState> finishedSplitIds) {
    requestSplit(Lists.newArrayList(finishedSplitIds.keySet()));
  }

  @Override
  protected AmoroSplitState initializedState(AmoroSplit split) {
    return new AmoroSplitState(split);
  }

  @Override
  protected AmoroSplit toSplitType(String splitId, AmoroSplitState splitState) {
