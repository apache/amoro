...
/** This is an amoro table writer factory. */
public class AmoroRowDataTaskWriterFactory implements TaskWriterFactory<RowData> {
  ...
  public AmoroRowDataTaskWriterFactory(MixedTable table, RowType flinkSchema, boolean overwrite) {
    this.table = table;
