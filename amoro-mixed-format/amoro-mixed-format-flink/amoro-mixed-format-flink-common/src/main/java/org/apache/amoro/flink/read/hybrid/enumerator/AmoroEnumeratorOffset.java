 ...
 */
public class AmoroEnumeratorOffset {
  private static final AmoroEnumeratorOffset EMPTY = of(Long.MIN_VALUE, Long.MIN_VALUE);
  ...
  private AmoroEnumeratorOffset(Long changeSnapshotId, Long snapshotTimestampMs) {
    this.changeSnapshotId = changeSnapshotId;
    this.snapshotTimestampMs = snapshotTimestampMs;
  }

  public static AmoroEnumeratorOffset of(Long changeSnapshotId, Long snapshotTimestampMs) {
    return new AmoroEnumeratorOffset(changeSnapshotId, snapshotTimestampMs);
  }

  public static AmoroEnumeratorOffset empty() {
    return EMPTY;
  }
  ...
  public boolean equals(Object o) {
    ...
    AmoroEnumeratorOffset other = (AmoroEnumeratorOffset) o;
