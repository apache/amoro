...
/** This is amoro table includes writing file data to un keyed table and keyed table. */
public class AmoroFileWriter extends AbstractStreamOperator<WriteResult>
    implements OneInputStreamOperator<RowData, WriteResult>, BoundedOneInput {

  private static final long serialVersionUID = 1L;
  private static final Logger LOG = LoggerFactory.getLogger(AmoroFileWriter.class);
  ...
  private void initTaskWriterFactory(long mask) {
    if (taskWriterFactory instanceof AmoroRowDataTaskWriterFactory) {
      ((AmoroRowDataTaskWriterFactory) taskWriterFactory).setMask(mask);
    }
