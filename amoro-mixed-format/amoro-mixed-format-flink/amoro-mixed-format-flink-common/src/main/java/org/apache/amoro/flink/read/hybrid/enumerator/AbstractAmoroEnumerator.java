...
public abstract class AbstractAmoroEnumerator
    implements SplitEnumerator<AmoroSplit, AmoroSourceEnumState> {
  private static final Logger LOG = LoggerFactory.getLogger(AbstractAmoroEnumerator.class);
  ...
  AbstractAmoroEnumerator(
      SplitEnumeratorContext<AmoroSplit> enumeratorContext, SplitAssigner assigner) {
  ...
  @Override
  public void addSplitsBack(List<AmoroSplit> splits, int subtaskId) {
  ...
  protected void assignSplits() {
    ...
    while (awaitingReader.hasNext()) {
      ...
      if (nextSplit.isAvailable()) {
        AmoroSplit arcticSplit = nextSplit.split();
        LOG.info(
