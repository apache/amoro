 ...
 * into split state.
 */
public class AmoroRecordEmitter<T>
    implements RecordEmitter<AmoroRecordWithOffset<T>, T, AmoroSplitState> {

  public static final Logger LOGGER = LoggerFactory.getLogger(AmoroRecordEmitter.class);

  /** It signifies whether the Long.MIN_VALUE need to be set into RowData. */
  public boolean populateRowTime;

  public AmoroRecordEmitter(boolean populateRowTime) {
    this.populateRowTime = populateRowTime;
  }

  @Override
  public void emitRecord(
      AmoroRecordWithOffset<T> element, SourceOutput<T> sourceOutput, AmoroSplitState split)
      throws Exception {
