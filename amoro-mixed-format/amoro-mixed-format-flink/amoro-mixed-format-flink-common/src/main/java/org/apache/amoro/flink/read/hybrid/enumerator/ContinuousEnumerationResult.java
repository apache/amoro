...
/** The result that contains {@link AmoroSplit}s and is generated by {@link FlinkSplitPlanner}. */
public class ContinuousEnumerationResult {
  public static final ContinuousEnumerationResult EMPTY =
      new ContinuousEnumerationResult(Collections.emptyList(), null, AmoroEnumeratorOffset.empty());

  private final Collection<AmoroSplit> splits;
  private final AmoroEnumeratorOffset fromOffset;
  private final AmoroEnumeratorOffset toOffset;
  ...
  public ContinuousEnumerationResult(
      Collection<AmoroSplit> splits,
      AmoroEnumeratorOffset fromOffset,
      AmoroEnumeratorOffset toOffset) {
  ...
  public Collection<AmoroSplit> splits() {
    return splits;
  }

  public AmoroEnumeratorOffset fromOffset() {
    return fromOffset;
  }

  public AmoroEnumeratorOffset toOffset() {
    return toOffset;
  }
