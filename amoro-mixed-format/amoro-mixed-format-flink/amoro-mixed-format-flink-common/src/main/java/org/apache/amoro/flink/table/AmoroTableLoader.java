...
public class AmoroTableLoader implements TableLoader {
  ...
  public static AmoroTableLoader of(
  ...
  public static AmoroTableLoader of(
    ...
    return new AmoroTableLoader(tableIdentifier, catalogBuilder, flinkTableProperties);
  }
