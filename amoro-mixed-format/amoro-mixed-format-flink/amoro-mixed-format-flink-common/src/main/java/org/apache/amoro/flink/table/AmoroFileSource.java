...
public class AmoroFileSource
  ...
  private static final Logger LOG = LoggerFactory.getLogger(AmoroFileSource.class);
  ...
  private AmoroFileSource(AmoroFileSource toCopy) {
  ...
  public DynamicTableSource copy() {
    return new AmoroFileSource(this);
  }
  ...
  public void applyWatermark(WatermarkStrategy<RowData> watermarkStrategy) {
    ...
    boolean dimTable =
        CompatibleFlinkPropertyUtil.propertyAsBoolean(conf, ArcticValidator.DIM_TABLE_ENABLE);
    if (!dimTable) {
