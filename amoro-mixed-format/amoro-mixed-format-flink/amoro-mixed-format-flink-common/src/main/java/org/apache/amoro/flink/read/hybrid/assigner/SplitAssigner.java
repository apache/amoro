...
/** An interface SplitAssigner for {@link AmoroSplit} */
public interface SplitAssigner extends Closeable {
  ...
  void onDiscoveredSplits(Collection<AmoroSplit> splits);

  /** Forward addSplitsBack event (for failed reader) to assigner */
  void onUnassignedSplits(Collection<AmoroSplit> splits);
  ...
  Collection<AmoroSplitState> state();
