...
public abstract class AmoroSplit implements SourceSplit, Serializable, Comparable<AmoroSplit> {
  ...
  @Override
  public int compareTo(AmoroSplit that) {
    return this.taskIndex().compareTo(that.taskIndex());
  }

  public abstract AmoroSplit copy();
}
