...
public class TestImpalaParquet {
  ...
  @Test
  public void genericReade() {
    Schema schema = new Schema(Types.NestedField.of(1, true, "str3", Types.StringType.get()));
    AdaptHiveParquet.ReadBuilder builder = AdaptHiveParquet.read(
            Files.localInput("/Users/shidayang/IdeaProjects/arctic-github/hive/src/test/resources/impala.parquet"))
        .project(schema)
