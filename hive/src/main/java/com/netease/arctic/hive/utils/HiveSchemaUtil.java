...
public class HiveSchemaUtil {
  ...
  public static void syncSchemaToHive(ArcticTable arcticTable, HMSClientPool client) {
    org.apache.hadoop.hive.metastore.api.Table tbl = HiveTableUtil.loadHmsTable(client, arcticTable.id());
    if (tbl == null) {
    ...
    HiveTableUtil.persistTable(client, tbl);
  }
}
