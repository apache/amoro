...
public class TestSnapshotExpire extends ExecutorTestBase {
  ...
  public void testNotExpireFlinkLatestCommit4ChangeTable() {
    ...
    Mockito.when(tableRuntime.getOptimizingStatus()).thenReturn(OptimizingStage.IDLE);
  ...
  public void testNotExpireOptimizeCommit4All() {
    ...
    Mockito.when(tableRuntime.getOptimizingStatus()).thenReturn(OptimizingStage.COMMITTING);
