...
import static com.netease.arctic.server.table.internal.InternalTableConstants.HADOOP_FILE_IO_IMPL;
import static com.netease.arctic.server.table.internal.InternalTableConstants.METADATA_FOLDER_NAME;
...
public class InternalTableUtil {
  ...
  public static boolean isKeyedMixedTable(
      com.netease.arctic.server.table.TableMetadata serverTableMetadata) {
