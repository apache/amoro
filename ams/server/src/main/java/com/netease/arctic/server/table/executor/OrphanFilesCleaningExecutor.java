...
import static com.netease.arctic.server.optimizing.maintainer.TableMaintainer.createMaintainerForTable;
...
public class OrphanFilesCleaningExecutor extends BaseTableExecutor {
  ...
  public void execute(TableRuntime tableRuntime) {
    try {
      ...
      TableMaintainer tableMaintainer = createMaintainerForTable(amoroTable);
