...
/**
 * Copy from org.apache.iceberg.spark.TypeToSparkType. Reason: 1.
 * org.apache.iceberg.spark.TypeToSparkType is package private. 2. iceberg-spark dependency is
 * runtime scope, so we can't use it in compile scope.
 */
