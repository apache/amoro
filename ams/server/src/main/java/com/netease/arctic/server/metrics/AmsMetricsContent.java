...
public class AmsMetricsContent implements MetricsContent<MetricsReport> {
  private final String name;
  private final MetricType type;
  private final MetricsReport data;

  private AmsMetricsContent(String name, MetricType type, MetricsReport data) {
    this.name = name;
    this.type = type;
    this.data = data;
  }
  ...
  public static MetricsContent<MetricsReport> wrap(MetricsReport report) {
    ...
    return new AmsMetricsContent(typedMetric.reportType().name(), MetricType.SERVICE, report);
  }
