...
(
    ...
    `last_major_optimizing_time`    datetime(3) DEFAULT NULL COMMENT 'Latest Major Optimize time for all partitions',
    `last_minor_optimizing_time`    datetime(3) DEFAULT NULL COMMENT 'Latest Minor Optimize time for all partitions',
    `last_full_optimizing_time`     datetime(3) DEFAULT NULL COMMENT 'Latest Full Optimize time for all partitions',
