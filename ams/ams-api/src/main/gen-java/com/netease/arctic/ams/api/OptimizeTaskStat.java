      ...
      if (struct.files != null) {
        if (struct.isSetFiles()) {
          oprot.writeFieldBegin(FILES_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter63 : struct.files)
            {
      ...
      if (struct.isSetFiles()) {
        {
          ...
          for (java.nio.ByteBuffer _iter64 : struct.files)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.files = new java.util.ArrayList<java.nio.ByteBuffer>(_list65.size);
