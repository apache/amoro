...
public class DataFile implements org.apache.thrift.TBase<DataFile, DataFile._Fields>, java.io.Serializable, Cloneable, Comparable<DataFile> {
  ...
  public @org.apache.thrift.annotation.Nullable String fileType; // required
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<String,java.nio.ByteBuffer> upperBounds; // required
  ...
  public DataFile(
    ...
    long recordCount,
    java.util.Map<String,java.nio.ByteBuffer> upperBounds)
  {
    this();
  ...
  public DataFile(DataFile other) {
    ...
    if (other.isSetUpperBounds()) {
      java.util.Map<String,java.nio.ByteBuffer> __this__upperBounds = new java.util.HashMap<String,java.nio.ByteBuffer>(other.upperBounds);
  ...
  public DataFile setFileType(@org.apache.thrift.annotation.Nullable String fileType) {
    this.fileType = fileType;
    return this;
  }
  ...
  public DataFile setPath(@org.apache.thrift.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public void putToUpperBounds(String key, java.nio.ByteBuffer val) {
    if (this.upperBounds == null) {
      this.upperBounds = new java.util.HashMap<String,java.nio.ByteBuffer>();
    }
    this.upperBounds.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<String,java.nio.ByteBuffer> getUpperBounds() {
    return this.upperBounds;
  }

  public DataFile setUpperBounds(@org.apache.thrift.annotation.Nullable java.util.Map<String,java.nio.ByteBuffer> upperBounds) {
    this.upperBounds = upperBounds;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case UPPER_BOUNDS:
      if (value == null) {
        ...
        setUpperBounds((java.util.Map<String,java.nio.ByteBuffer>)value);
      }
      break;
  ...
  public int compareTo(DataFile other) {
    ...
    lastComparison = Boolean.valueOf(isSetUpperBounds()).compareTo(other.isSetUpperBounds());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpperBounds()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.upperBounds = new java.util.HashMap<String,java.nio.ByteBuffer>(2*_map33.size);
                @org.apache.thrift.annotation.Nullable String _key34;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataFile struct) throws org.apache.thrift.TException {
      ...
      if (struct.upperBounds != null) {
        oprot.writeFieldBegin(UPPER_BOUNDS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, java.nio.ByteBuffer> _iter38 : struct.upperBounds.entrySet())
          {
      ...
      if (struct.isSetUpperBounds()) {
        {
          ...
          for (java.util.Map.Entry<String, java.nio.ByteBuffer> _iter40 : struct.upperBounds.entrySet())
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.upperBounds = new java.util.HashMap<String,java.nio.ByteBuffer>(2*_map44.size);
