...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2022-11-14")
public class OptimizeTask implements org.apache.thrift.TBase<OptimizeTask, OptimizeTask._Fields>, java.io.Serializable, Cloneable, Comparable<OptimizeTask> {
  ...
  private static final org.apache.thrift.protocol.TField ICEBERG_FILE_SCAN_TASKS_FIELD_DESC = new org.apache.thrift.protocol.TField("icebergFileScanTasks", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> icebergFileScanTasks; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ICEBERG_FILE_SCAN_TASKS((short)8, "icebergFileScanTasks"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 7: // SOURCE_NODES
          return SOURCE_NODES;
        case 8: // ICEBERG_FILE_SCAN_TASKS
          return ICEBERG_FILE_SCAN_TASKS;
        case 9: // PROPERTIES
          return PROPERTIES;
        default:
          return null;
  ...
  private static final _Fields optionals[] = {_Fields.INSERT_FILES,_Fields.DELETE_FILES,_Fields.BASE_FILES,_Fields.POS_DELETE_FILES,_Fields.SOURCE_NODES,_Fields.ICEBERG_FILE_SCAN_TASKS,_Fields.PROPERTIES};
  ...
  static {
    ...
    tmpMap.put(_Fields.ICEBERG_FILE_SCAN_TASKS, new org.apache.thrift.meta_data.FieldMetaData("icebergFileScanTasks", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING            , true))));
  ...
  public OptimizeTask(OptimizeTask other) {
    ...
    if (other.isSetIcebergFileScanTasks()) {
      java.util.List<java.nio.ByteBuffer> __this__icebergFileScanTasks = new java.util.ArrayList<java.nio.ByteBuffer>(other.icebergFileScanTasks);
      this.icebergFileScanTasks = __this__icebergFileScanTasks;
    }
  ...
  public void clear() {
    ...
    this.icebergFileScanTasks = null;
  ...
  public int getIcebergFileScanTasksSize() {
    return (this.icebergFileScanTasks == null) ? 0 : this.icebergFileScanTasks.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.nio.ByteBuffer> getIcebergFileScanTasksIterator() {
    return (this.icebergFileScanTasks == null) ? null : this.icebergFileScanTasks.iterator();
  }

  public void addToIcebergFileScanTasks(java.nio.ByteBuffer elem) {
    if (this.icebergFileScanTasks == null) {
      this.icebergFileScanTasks = new java.util.ArrayList<java.nio.ByteBuffer>();
    }
    this.icebergFileScanTasks.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.nio.ByteBuffer> getIcebergFileScanTasks() {
    return this.icebergFileScanTasks;
  }

  public OptimizeTask setIcebergFileScanTasks(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> icebergFileScanTasks) {
    this.icebergFileScanTasks = icebergFileScanTasks;
    return this;
  }

  public void unsetIcebergFileScanTasks() {
    this.icebergFileScanTasks = null;
  }

  /** Returns true if field icebergFileScanTasks is set (has been assigned a value) and false otherwise */
  public boolean isSetIcebergFileScanTasks() {
    return this.icebergFileScanTasks != null;
  }

  public void setIcebergFileScanTasksIsSet(boolean value) {
    if (!value) {
      this.icebergFileScanTasks = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case ICEBERG_FILE_SCAN_TASKS:
      if (value == null) {
        unsetIcebergFileScanTasks();
      } else {
        setIcebergFileScanTasks((java.util.List<java.nio.ByteBuffer>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ICEBERG_FILE_SCAN_TASKS:
      return getIcebergFileScanTasks();
  ...
  public boolean isSet(_Fields field) {
    ...
    case ICEBERG_FILE_SCAN_TASKS:
      return isSetIcebergFileScanTasks();
    case PROPERTIES:
  ...
  public boolean equals(OptimizeTask that) {
    ...
    boolean this_present_icebergFileScanTasks = true && this.isSetIcebergFileScanTasks();
    boolean that_present_icebergFileScanTasks = true && that.isSetIcebergFileScanTasks();
    if (this_present_icebergFileScanTasks || that_present_icebergFileScanTasks) {
      if (!(this_present_icebergFileScanTasks && that_present_icebergFileScanTasks))
        return false;
      if (!this.icebergFileScanTasks.equals(that.icebergFileScanTasks))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIcebergFileScanTasks()) ? 131071 : 524287);
    if (isSetIcebergFileScanTasks())
      hashCode = hashCode * 8191 + icebergFileScanTasks.hashCode();
  ...
  public int compareTo(OptimizeTask other) {
    ...
    lastComparison = Boolean.valueOf(isSetIcebergFileScanTasks()).compareTo(other.isSetIcebergFileScanTasks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIcebergFileScanTasks()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.icebergFileScanTasks, other.icebergFileScanTasks);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetIcebergFileScanTasks()) {
      if (!first) sb.append(", ");
      sb.append("icebergFileScanTasks:");
      if (this.icebergFileScanTasks == null) {
        sb.append("null");
      } else {
        org.apache.thrift.TBaseHelper.toString(this.icebergFileScanTasks, sb);
      }
      first = false;
    }
    if (isSetProperties()) {
  ...
  private static class OptimizeTaskStandardScheme extends org.apache.thrift.scheme.StandardScheme<OptimizeTask> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.icebergFileScanTasks = new java.util.ArrayList<java.nio.ByteBuffer>(_list15.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem16;
                for (int _i17 = 0; _i17 < _list15.size; ++_i17)
                {
                  _elem16 = iprot.readBinary();
                  struct.icebergFileScanTasks.add(_elem16);
                }
                iprot.readListEnd();
              }
              struct.setIcebergFileScanTasksIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OptimizeTask struct) throws org.apache.thrift.TException {
      ...
      if (struct.posDeleteFiles != null) {
        if (struct.isSetPosDeleteFiles()) {
          oprot.writeFieldBegin(POS_DELETE_FILES_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter25 : struct.posDeleteFiles)
            {
      ...
      if (struct.sourceNodes != null) {
        if (struct.isSetSourceNodes()) {
          oprot.writeFieldBegin(SOURCE_NODES_FIELD_DESC);
          {
            ...
            for (TreeNode _iter26 : struct.sourceNodes)
            {
              _iter26.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.icebergFileScanTasks != null) {
        if (struct.isSetIcebergFileScanTasks()) {
          oprot.writeFieldBegin(ICEBERG_FILE_SCAN_TASKS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.icebergFileScanTasks.size()));
            for (java.nio.ByteBuffer _iter27 : struct.icebergFileScanTasks)
            {
  ...
  private static class OptimizeTaskTupleScheme extends org.apache.thrift.scheme.TupleScheme<OptimizeTask> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, OptimizeTask struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPosDeleteFiles()) {
        {
          ...
          for (java.nio.ByteBuffer _iter32 : struct.posDeleteFiles)
          {
      ...
      if (struct.isSetSourceNodes()) {
        {
          ...
          for (TreeNode _iter33 : struct.sourceNodes)
          {
            _iter33.write(oprot);
          }
        }
      ...
      if (struct.isSetIcebergFileScanTasks()) {
        {
          oprot.writeI32(struct.icebergFileScanTasks.size());
          for (java.nio.ByteBuffer _iter34 : struct.icebergFileScanTasks)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.posDeleteFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list45.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = iprot.readBinary();
            struct.posDeleteFiles.add(_elem46);
          }
        }
        struct.setPosDeleteFilesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.sourceNodes = new java.util.ArrayList<TreeNode>(_list48.size);
          @org.apache.thrift.annotation.Nullable TreeNode _elem49;
          for (int _i50 = 0; _i50 < _list48.size; ++_i50)
          {
            _elem49 = new TreeNode();
            _elem49.read(iprot);
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.icebergFileScanTasks = new java.util.ArrayList<java.nio.ByteBuffer>(_list51.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = iprot.readBinary();
            struct.icebergFileScanTasks.add(_elem52);
          }
        }
        struct.setIcebergFileScanTasksIsSet(true);
      }
