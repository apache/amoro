...
public class OptimizeTask implements org.apache.thrift.TBase<OptimizeTask, OptimizeTask._Fields>, java.io.Serializable, Cloneable, Comparable<OptimizeTask> {
  ...
  public OptimizeTask setTableIdentifier(@org.apache.thrift.annotation.Nullable com.netease.arctic.ams.api.TableIdentifier tableIdentifier) {
    this.tableIdentifier = tableIdentifier;
    return this;
  }
  ...
  public OptimizeTask setProperties(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> properties) {
  ...
  public int compareTo(OptimizeTask other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInsertFiles()).compareTo(other.isSetInsertFiles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInsertFiles()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBaseFiles()).compareTo(other.isSetBaseFiles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBaseFiles()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPosDeleteFiles()).compareTo(other.isSetPosDeleteFiles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPosDeleteFiles()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("OptimizeTask(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.insertFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list10.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = iprot.readBinary();
                  struct.insertFiles.add(_elem11);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deleteFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list13.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem14;
                for (int _i15 = 0; _i15 < _list13.size; ++_i15)
                {
                  _elem14 = iprot.readBinary();
                  struct.deleteFiles.add(_elem14);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.baseFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list16.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = iprot.readBinary();
                  struct.baseFiles.add(_elem17);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.posDeleteFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list19.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = iprot.readBinary();
                  struct.posDeleteFiles.add(_elem20);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sourceNodes = new java.util.ArrayList<TreeNode>(_list22.size);
                @org.apache.thrift.annotation.Nullable TreeNode _elem23;
                for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                {
                  _elem23 = new TreeNode();
                  _elem23.read(iprot);
                  struct.sourceNodes.add(_elem23);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map25.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key26;
                @org.apache.thrift.annotation.Nullable java.lang.String _val27;
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter34 : struct.properties.entrySet())
            {
      ...
      if (struct.isSetInsertFiles()) {
        {
          ...
          for (java.nio.ByteBuffer _iter35 : struct.insertFiles)
          {
      ...
      if (struct.isSetDeleteFiles()) {
        {
          ...
          for (java.nio.ByteBuffer _iter36 : struct.deleteFiles)
          {
      ...
      if (struct.isSetBaseFiles()) {
        {
          ...
          for (java.nio.ByteBuffer _iter37 : struct.baseFiles)
          {
      ...
      if (struct.isSetPosDeleteFiles()) {
        {
          ...
          for (java.nio.ByteBuffer _iter38 : struct.posDeleteFiles)
          {
      ...
      if (struct.isSetSourceNodes()) {
        {
          ...
          for (TreeNode _iter39 : struct.sourceNodes)
          {
            _iter39.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.insertFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list41.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem42;
          for (int _i43 = 0; _i43 < _list41.size; ++_i43)
          {
            _elem42 = iprot.readBinary();
            struct.insertFiles.add(_elem42);
          }
        }
        struct.setInsertFilesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.deleteFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list44.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem45;
          for (int _i46 = 0; _i46 < _list44.size; ++_i46)
          {
            _elem45 = iprot.readBinary();
            struct.deleteFiles.add(_elem45);
          }
        }
        struct.setDeleteFilesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.baseFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list47.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = iprot.readBinary();
            struct.baseFiles.add(_elem48);
          }
        }
        struct.setBaseFilesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.posDeleteFiles = new java.util.ArrayList<java.nio.ByteBuffer>(_list50.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem51;
          for (int _i52 = 0; _i52 < _list50.size; ++_i52)
          {
            _elem51 = iprot.readBinary();
            struct.posDeleteFiles.add(_elem51);
          }
        }
        struct.setPosDeleteFilesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.sourceNodes = new java.util.ArrayList<TreeNode>(_list53.size);
          @org.apache.thrift.annotation.Nullable TreeNode _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = new TreeNode();
            _elem54.read(iprot);
            struct.sourceNodes.add(_elem54);
          }
        }
        struct.setSourceNodesIsSet(true);
      }
