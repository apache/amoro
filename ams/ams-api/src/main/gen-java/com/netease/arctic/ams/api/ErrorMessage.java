...
public class ErrorMessage implements org.apache.thrift.TBase<ErrorMessage, ErrorMessage._Fields>, java.io.Serializable, Cloneable, Comparable<ErrorMessage> {
  ...
  public @org.apache.thrift.annotation.Nullable String failReason; // required
  ...
  public ErrorMessage setFailReason(@org.apache.thrift.annotation.Nullable String failReason) {
    this.failReason = failReason;
    return this;
  }
  ...
  public int compareTo(ErrorMessage other) {
    ...
    lastComparison = Boolean.valueOf(isSetFailTime()).compareTo(other.isSetFailTime());
    if (lastComparison != 0) {
