...
public class OptimizeTaskId implements org.apache.thrift.TBase<OptimizeTaskId, OptimizeTaskId._Fields>, java.io.Serializable, Cloneable, Comparable<OptimizeTaskId> {
  ...
  public @org.apache.thrift.annotation.Nullable String traceId; // required
  ...
  public OptimizeTaskId setTraceId(@org.apache.thrift.annotation.Nullable String traceId) {
    this.traceId = traceId;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OptimizeTaskId(");
    boolean first = true;
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = OptimizeType.findByValue(iprot.readI32());
