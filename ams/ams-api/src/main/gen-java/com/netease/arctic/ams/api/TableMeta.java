            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.locations = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map86.size);
                ...
                for (int _i89 = 0; _i89 < _map86.size; ++_i89)
                {
                  ...
                  struct.locations.put(_key87, _val88);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableMeta struct) throws org.apache.thrift.TException {
      ...
      if (struct.locations != null) {
        oprot.writeFieldBegin(LOCATIONS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter91 : struct.locations.entrySet())
          {
      ...
      if (struct.isSetLocations()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter93 : struct.locations.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.locations = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map98.size);
          ...
          for (int _i101 = 0; _i101 < _map98.size; ++_i101)
          {
            ...
            struct.locations.put(_key99, _val100);
          }
        }
        struct.setLocationsIsSet(true);
      }
