...
public class TableMeta implements org.apache.thrift.TBase<TableMeta, TableMeta._Fields>, java.io.Serializable, Cloneable, Comparable<TableMeta> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> locations; // required
  ...
  public TableMeta(
    ...
    java.util.Map<String, String> locations)
  {
    this();
  ...
  public TableMeta(TableMeta other) {
    ...
    if (other.isSetLocations()) {
      java.util.Map<String, String> __this__locations = new java.util.HashMap<String, String>(other.locations);
  ...
  public TableMeta setProperties(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> properties) {
  ...
  public void putToLocations(String key, String val) {
    if (this.locations == null) {
      this.locations = new java.util.HashMap<String, String>();
    }
    this.locations.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<String, String> getLocations() {
    return this.locations;
  }

  public TableMeta setLocations(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> locations) {
    this.locations = locations;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case LOCATIONS:
      if (value == null) {
        ...
        setLocations((java.util.Map<String, String>)value);
      }
      break;
  ...
  public int compareTo(TableMeta other) {
    ...
    lastComparison = Boolean.valueOf(isSetKeySpec()).compareTo(other.isSetKeySpec());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKeySpec()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<String, String>(2*_map90.size);
                @org.apache.thrift.annotation.Nullable String _key91;
                @org.apache.thrift.annotation.Nullable String _val92;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.locations = new java.util.HashMap<String, String>(2*_map94.size);
                @org.apache.thrift.annotation.Nullable String _key95;
                @org.apache.thrift.annotation.Nullable String _val96;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableMeta struct) throws org.apache.thrift.TException {
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<String, String> _iter98 : struct.properties.entrySet())
            {
      ...
      if (struct.locations != null) {
        oprot.writeFieldBegin(LOCATIONS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, String> _iter99 : struct.locations.entrySet())
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter100 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetLocations()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter101 : struct.locations.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.properties = new java.util.HashMap<String, String>(2*_map102.size);
          @org.apache.thrift.annotation.Nullable String _key103;
          @org.apache.thrift.annotation.Nullable String _val104;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.locations = new java.util.HashMap<String, String>(2*_map106.size);
          @org.apache.thrift.annotation.Nullable String _key107;
          @org.apache.thrift.annotation.Nullable String _val108;
