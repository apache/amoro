            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.optimizerState = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map68.size);
                ...
                for (int _i71 = 0; _i71 < _map68.size; ++_i71)
                {
                  ...
                  struct.optimizerState.put(_key69, _val70);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OptimizerStateReport struct) throws org.apache.thrift.TException {
      ...
      if (struct.optimizerState != null) {
        oprot.writeFieldBegin(OPTIMIZER_STATE_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter72 : struct.optimizerState.entrySet())
          {
      ...
      if (struct.isSetOptimizerState()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter73 : struct.optimizerState.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.optimizerState = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map74.size);
          ...
          for (int _i77 = 0; _i77 < _map74.size; ++_i77)
          {
            ...
            struct.optimizerState.put(_key75, _val76);
          }
        }
        struct.setOptimizerStateIsSet(true);
      }
