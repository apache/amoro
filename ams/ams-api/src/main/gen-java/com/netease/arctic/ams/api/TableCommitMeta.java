...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2022-08-11")
public class TableCommitMeta implements org.apache.thrift.TBase<TableCommitMeta, TableCommitMeta._Fields>, java.io.Serializable, Cloneable, Comparable<TableCommitMeta> {
  ...
  private static final org.apache.thrift.protocol.TField OPTIMIZE_PRODUCED_FIELD_DESC = new org.apache.thrift.protocol.TField("optimizeProduced", org.apache.thrift.protocol.TType.BOOL, (short)6);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<String, String> properties; // required
  public boolean optimizeProduced; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    OPTIMIZE_PRODUCED((short)6, "optimizeProduced");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // PROPERTIES
          return PROPERTIES;
        case 6: // OPTIMIZE_PRODUCED
          return OPTIMIZE_PRODUCED;
        default:
          return null;
      }
    }
  ...
  private static final int __OPTIMIZEPRODUCED_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.PROPERTIES, new org.apache.thrift.meta_data.FieldMetaData("properties", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.OPTIMIZE_PRODUCED, new org.apache.thrift.meta_data.FieldMetaData("optimizeProduced", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    boolean optimizeProduced)
  {
    ...
    this.optimizeProduced = optimizeProduced;
    setOptimizeProducedIsSet(true);
  }
  ...
  public TableCommitMeta(TableCommitMeta other) {
    ...
    this.optimizeProduced = other.optimizeProduced;
  }
  ...
  public void clear() {
    ...
    setOptimizeProducedIsSet(false);
    this.optimizeProduced = false;
  }
  ...
  public TableCommitMeta setAction(@org.apache.thrift.annotation.Nullable String action) {
    this.action = action;
    return this;
  }
  ...
  public TableCommitMeta setProperties(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> properties) {
    this.properties = properties;
    return this;
  }
  ...
  public boolean isOptimizeProduced() {
    return this.optimizeProduced;
  }

  public TableCommitMeta setOptimizeProduced(boolean optimizeProduced) {
    this.optimizeProduced = optimizeProduced;
    setOptimizeProducedIsSet(true);
    return this;
  }

  public void unsetOptimizeProduced() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __OPTIMIZEPRODUCED_ISSET_ID);
  }

  /** Returns true if field optimizeProduced is set (has been assigned a value) and false otherwise */
  public boolean isSetOptimizeProduced() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __OPTIMIZEPRODUCED_ISSET_ID);
  }

  public void setOptimizeProducedIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __OPTIMIZEPRODUCED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case OPTIMIZE_PRODUCED:
      if (value == null) {
        unsetOptimizeProduced();
      } else {
        setOptimizeProduced((Boolean)value);
      }
      break;
  ...
  public boolean equals(TableCommitMeta that) {
    ...
    boolean this_present_optimizeProduced = true;
    boolean that_present_optimizeProduced = true;
    if (this_present_optimizeProduced || that_present_optimizeProduced) {
      if (!(this_present_optimizeProduced && that_present_optimizeProduced))
        return false;
      if (this.optimizeProduced != that.optimizeProduced)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((optimizeProduced) ? 131071 : 524287);
  ...
  public int compareTo(TableCommitMeta other) {
    ...
    lastComparison = Boolean.valueOf(isSetOptimizeProduced()).compareTo(other.isSetOptimizeProduced());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOptimizeProduced()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.optimizeProduced, other.optimizeProduced);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("optimizeProduced:");
    sb.append(this.optimizeProduced);
    first = false;
    sb.append(")");
    return sb.toString();
  }
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<String, String>(2*_map67.size);
                @org.apache.thrift.annotation.Nullable String _key68;
                @org.apache.thrift.annotation.Nullable String _val69;
          ...
          case 6: // OPTIMIZE_PRODUCED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.optimizeProduced = iprot.readBool();
              struct.setOptimizeProducedIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableCommitMeta struct) throws org.apache.thrift.TException {
      ...
      if (struct.properties != null) {
        oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<String, String> _iter72 : struct.properties.entrySet())
          {
      ...
      oprot.writeFieldBegin(OPTIMIZE_PRODUCED_FIELD_DESC);
      oprot.writeBool(struct.optimizeProduced);
      oprot.writeFieldEnd();
  ...
  private static class TableCommitMetaTupleScheme extends org.apache.thrift.scheme.TupleScheme<TableCommitMeta> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TableCommitMeta struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOptimizeProduced()) {
        optionals.set(5);
      }
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<String, String> _iter74 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.properties = new java.util.HashMap<String, String>(2*_map78.size);
          @org.apache.thrift.annotation.Nullable String _key79;
          @org.apache.thrift.annotation.Nullable String _val80;
