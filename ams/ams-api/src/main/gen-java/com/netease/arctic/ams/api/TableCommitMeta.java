...
public class TableCommitMeta implements org.apache.thrift.TBase<TableCommitMeta, TableCommitMeta._Fields>, java.io.Serializable, Cloneable, Comparable<TableCommitMeta> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TableMetric> metrics; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.METRICS, new org.apache.thrift.meta_data.FieldMetaData("metrics", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TableMetric.class))));
  ...
  public TableCommitMeta(
    ...
    java.util.List<TableMetric> metrics)
  {
    this();
  ...
  public TableCommitMeta(TableCommitMeta other) {
    ...
    if (other.isSetMetrics()) {
      java.util.List<TableMetric> __this__metrics = new java.util.ArrayList<TableMetric>(other.metrics.size());
      for (TableMetric other_element : other.metrics) {
        __this__metrics.add(new TableMetric(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<TableMetric> getMetricsIterator() {
    return (this.metrics == null) ? null : this.metrics.iterator();
  }

  public void addToMetrics(TableMetric elem) {
    if (this.metrics == null) {
      this.metrics = new java.util.ArrayList<TableMetric>();
    }
    this.metrics.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<TableMetric> getMetrics() {
    return this.metrics;
  }

  public TableCommitMeta setMetrics(@org.apache.thrift.annotation.Nullable java.util.List<TableMetric> metrics) {
    this.metrics = metrics;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case METRICS:
      if (value == null) {
        ...
        setMetrics((java.util.List<TableMetric>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new java.util.ArrayList<TableMetric>(_list71.size);
                @org.apache.thrift.annotation.Nullable TableMetric _elem72;
                for (int _i73 = 0; _i73 < _list71.size; ++_i73)
                {
                  _elem72 = new TableMetric();
                  _elem72.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TableCommitMeta struct) throws org.apache.thrift.TException {
      ...
      if (struct.changes != null) {
        oprot.writeFieldBegin(CHANGES_FIELD_DESC);
        {
          ...
          for (TableChange _iter74 : struct.changes)
          {
            _iter74.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (TableMetric _iter76 : struct.metrics)
          {
            _iter76.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetChanges()) {
        {
          ...
          for (TableChange _iter77 : struct.changes)
          {
            _iter77.write(oprot);
          }
        }
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter78 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetMetrics()) {
        {
          ...
          for (TableMetric _iter79 : struct.metrics)
          {
            _iter79.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.changes = new java.util.ArrayList<TableChange>(_list80.size);
          @org.apache.thrift.annotation.Nullable TableChange _elem81;
          for (int _i82 = 0; _i82 < _list80.size; ++_i82)
          {
            _elem81 = new TableChange();
            _elem81.read(iprot);
            struct.changes.add(_elem81);
          }
        }
        struct.setChangesIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.metrics = new java.util.ArrayList<TableMetric>(_list87.size);
          @org.apache.thrift.annotation.Nullable TableMetric _elem88;
          for (int _i89 = 0; _i89 < _list87.size; ++_i89)
          {
            _elem88 = new TableMetric();
            _elem88.read(iprot);
