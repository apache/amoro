...
public class TableCommitMeta implements org.apache.thrift.TBase<TableCommitMeta, TableCommitMeta._Fields>, java.io.Serializable, Cloneable, Comparable<TableCommitMeta> {
  ...
  public int compareTo(TableCommitMeta other) {
    ...
    lastComparison = Boolean.valueOf(isSetCommitMetaProducer()).compareTo(other.isSetCommitMetaProducer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCommitMetaProducer()) {
    ...
    lastComparison = Boolean.valueOf(isSetSchemaUpdateMeta()).compareTo(other.isSetSchemaUpdateMeta());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSchemaUpdateMeta()) {
