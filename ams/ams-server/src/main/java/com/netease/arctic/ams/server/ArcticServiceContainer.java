...
import com.netease.arctic.ams.server.dashboard.DashboardServer;
import com.netease.arctic.ams.server.dashboard.utils.AmsUtils;
import com.netease.arctic.ams.server.persistence.SqlSessionFactoryProvider;
...
import com.netease.arctic.ams.server.table.executor.AsyncTableExecutors;
...
public class ArcticServiceContainer {
  ...
  private ArcticServiceContainer() throws IllegalConfigurationException {
    initConfig();
  ...
  private void initConfig() throws IllegalConfigurationException {
  ...
  private class ConfigurationHelper {
    ...
    public void init() throws IllegalConfigurationException {
      initServiceConfig();
      initContainerConfig();
    ...
    private void initServiceConfig() {
      ...
      yamlConfig = loadYaml(configPath);
  ...
  @SuppressWarnings("unchecked")
  private JSONObject loadYaml(String path) {
