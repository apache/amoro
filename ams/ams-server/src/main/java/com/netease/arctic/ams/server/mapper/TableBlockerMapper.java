...
import com.netease.arctic.ams.server.mybatis.List2StringConverter;
...
public interface TableBlockerMapper {
  ...
  List<TableBlocker> selectBlockers(@Param("tableIdentifier") TableIdentifier tableIdentifier, @Param("now") long now);
