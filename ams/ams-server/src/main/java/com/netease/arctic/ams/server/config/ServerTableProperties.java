...
public class ServerTableProperties {
  ...
  static {
    ...
    HIDDEN_EXPOSED.add(TableProperties.UPGRADE_ENABLE);
    HIDDEN_EXPOSED.add(TableProperties.PROTECTED_PROPERTIES.toString());
    HIDDEN_EXPOSED.add(TableProperties.BASE_HIVE_LOCATION_ROOT);
    HIDDEN_EXPOSED.add(TableProperties.PARTITION_PROPERTIES_KEY_HIVE_LOCATION);
