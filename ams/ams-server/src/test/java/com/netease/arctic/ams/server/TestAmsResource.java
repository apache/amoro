...
public class TestAmsResource extends ExternalResource {
  private static final Logger LOG = LoggerFactory.getLogger(com.netease.arctic.TestAms.class);
  ...
  public String getUrl(String catalogName) {
    return mockAms.getUrl(catalogName);
  }
