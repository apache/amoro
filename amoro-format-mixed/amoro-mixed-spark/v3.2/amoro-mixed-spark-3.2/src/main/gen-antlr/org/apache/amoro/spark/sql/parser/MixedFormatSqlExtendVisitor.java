...
public interface MixedFormatSqlExtendVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MixedFormatSqlExtendParser#tablePropertyList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTablePropertyList(MixedFormatSqlExtendParser.TablePropertyListContext ctx);
	/**
	 * Visit a parse tree produced by {@link MixedFormatSqlExtendParser#tableProperty}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTableProperty(MixedFormatSqlExtendParser.TablePropertyContext ctx);
	/**
	 * Visit a parse tree produced by {@link MixedFormatSqlExtendParser#tablePropertyKey}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTablePropertyKey(MixedFormatSqlExtendParser.TablePropertyKeyContext ctx);
	/**
	 * Visit a parse tree produced by {@link MixedFormatSqlExtendParser#tablePropertyValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTablePropertyValue(MixedFormatSqlExtendParser.TablePropertyValueContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MixedFormatSqlExtendParser#colPosition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColPosition(MixedFormatSqlExtendParser.ColPositionContext ctx);
	/**
