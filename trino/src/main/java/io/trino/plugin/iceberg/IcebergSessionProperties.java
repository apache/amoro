...
/**
 * Copy from IcebergSessionProperties to remove HaveConfig, because HaveConfig need something in trino-hive
 */
  ...
  public IcebergSessionProperties(
    ...
    sessionProperties = ImmutableList.<PropertyMetadata<?>>builder()
        ...
        .add(stringProperty(
            ...
            // Session-level redirections configuration does not work well with views,
            // as view body is analyzed in context
            // of a session with properties stripped off. Thus, this property is more
            // of a test-only, or at most POC usefulness.
            true))
        .add(durationProperty(
